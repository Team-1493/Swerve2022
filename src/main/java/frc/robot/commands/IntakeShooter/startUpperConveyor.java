...
public class startUpperConveyor extends CommandBase {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})

  private IntakeConveyor m_intakeConveyor;


  public startUpperConveyor(IntakeConveyor intakeConveyor) {
  ...
  @Override
  public void execute() {
    m_intakeConveyor.startUpperConveyor();
  }
  ...
  public boolean isFinished() {
    ...
    return (m_intakeConveyor.ballAtTop());
  }
